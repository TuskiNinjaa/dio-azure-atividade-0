...
Em seguida, acesse o [Speech Studio](https://speech.microsoft.com/portal) para acessar os serviços de processamento de fala e dentro do portal selecione o recurso criado.
